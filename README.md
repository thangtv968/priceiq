...
**▶️ [Live demo](https://priceiq-ai.streamlit.app/)** — click and explore the dashboard yourself.
...
[![PriceIQ dashboard](docs/dashboard.png)](https://priceiq-ai.streamlit.app/)
